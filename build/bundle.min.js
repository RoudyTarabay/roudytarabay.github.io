!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={i:r,l:!1,exports:{}};return e[r].call(i.exports,i,i.exports,t),i.l=!0,i.exports}var n={};t.m=e,t.c=n,t.d=function(e,n,r){t.o(e,n)||Object.defineProperty(e,n,{configurable:!1,enumerable:!0,get:r})},t.n=function(e){var n=e&&e.__esModule?function(){return e.default}:function(){return e};return t.d(n,"a",n),n},t.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},t.p="",t(t.s=0)}([function(e,t,n){"use strict";function r(e,t){a("div.drawer[name="+e+"]").toggleClass("open-drawer");var n=t.target;"DIV"!==n.tagName&&(n=t.target.parentElement),a(n).css({transform:"translate(0px, 0) rotate(20deg) skew(20deg)"}),a(n).on("transitionend webkitTransitionEnd oTransitionEnd",function(){a(n).toggleClass("invisible"),a(".original[name="+e+"]").toggleClass("invisible"),a(n).off("transitionend webkitTransitionEnd oTransitionEnd")})}function i(e){var t=a(".parallelogram.cloned:not('.invisible')");t.css({transform:"translate(0px, 0) rotate(20deg) skew(20deg)"}),t.on("transitionend webkitTransitionEnd oTransitionEnd",function(){a(".original:not([name="+e+"])").removeClass("invisible"),a(".parallelogram.cloned:not([name="+e+"])").addClass("invisible"),t.off("transitionend webkitTransitionEnd oTransitionEnd")}),"about"==e?a(".drawer").removeClass("open-drawer"):a(".drawer[name="+e+"]").hasClass("open-drawer")||(a(".original[name="+e+"]").toggleClass("invisible"),a(".parallelogram.cloned[name="+e+"]").toggleClass("invisible"),a(".parallelogram.cloned[name="+e+"]").css({transform:"translate("+(a(".drawer").width()-5)+"px, 0px) rotate(20deg) skew(20deg)"}),a("div:not([name="+e+"]).drawer").removeClass("open-drawer"),a("div.drawer[name="+e+"]").toggleClass("open-drawer"))}var o=n(1);!function(e){e&&e.__esModule}(o);n(2);var a=n(3);n(4),a(window).resize(function(){var e=a(".parallelogram.cloned:not('.invisible')");e.css({transform:"translate(0px, 0) rotate(20deg) skew(20deg)"}),e.css({transform:"translate("+(a(".drawer").width()-5)+"px, 0px) rotate(20deg) skew(20deg)"}),a(".overlay").each(function(){a(this).css("width",a("img[name="+a(this).attr("name")+"]").width()),a(this).css("height",a("img[name="+a(this).attr("name")+"]").height())})}),a(document).ready(function(){a(".overlay").each(function(){a(this).css("width",a("img[name="+a(this).attr("name")+"]").width()),a(this).css("height",a("img[name="+a(this).attr("name")+"]").height())})}),function(){a(document).ready(function(){a("#follow-button").css("background-color","red!important")})}(),a(window).on("load",function(){a(".original").each(function(e,t){var n=a("div[name="+a(t).attr("name")+"].original").clone();n.on("click",function(e){r(a(t).attr("name"),e)}),n.removeClass("original"),n.css({position:"absolute","background-color":a("div[name="+a(t).attr("name")+"].parallelogram"),transform:"rotate(20deg) skew(20deg)","webkit-transform":"rotate(20deg) skew(20deg)","transform-origin":"top left",top:a("div[name="+a(t).attr("name")+"].original").offset().top,left:a("div[name="+a(t).attr("name")+"].original").offset().left,transition:"transform 1s"}),a("nav").append(n),n.addClass("parallelogram"),n.addClass("cloned"),n.toggleClass("invisible")}),a(".original").each(function(e,t){a(t).on("click",function(){i(a(t).attr("name"))})})})},function(e,t){},function(e,t){},function(e,t,n){var r,i;/*!
