!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={i:r,l:!1,exports:{}};return e[r].call(i.exports,i,i.exports,t),i.l=!0,i.exports}var n={};t.m=e,t.c=n,t.d=function(e,n,r){t.o(e,n)||Object.defineProperty(e,n,{configurable:!1,enumerable:!0,get:r})},t.n=function(e){var n=e&&e.__esModule?function(){return e.default}:function(){return e};return t.d(n,"a",n),n},t.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},t.p="",t(t.s=0)}([function(e,t,n){"use strict";function r(e,t){console.log("cloned"),o("div.drawer[name="+e+"]").toggleClass("open-drawer");var n=t.target;"DIV"!==n.tagName&&(n=t.target.parentElement),o(n).css({transform:"translate(0px, 0) rotate(20deg) skew(20deg)"}),o(n).on("transitionend webkitTransitionEnd oTransitionEnd",function(){o(n).toggleClass("invisible"),o(".original[name="+e+"]").toggleClass("invisible"),o(n).off("transitionend webkitTransitionEnd oTransitionEnd")})}function i(e){var t=o(".parallelogram.cloned:not('.invisible')");t.css({transform:"translate(0px, 0) rotate(20deg) skew(20deg)"}),t.on("transitionend webkitTransitionEnd oTransitionEnd",function(){o(".original:not([name="+e+"])").removeClass("invisible"),o(".parallelogram.cloned:not([name="+e+"])").addClass("invisible"),t.off("transitionend webkitTransitionEnd oTransitionEnd")}),window.scrollTo(0,0),"about"==e?(o(".drawer").removeClass("open-drawer"),o(".drawer").on("transitionend webkitTransitionEnd oTransitionEnd",function(){o(".drawer").addClass("hidden"),o(".drawer").off("transitionend webkitTransitionEnd oTransitionEnd")})):o(".drawer[name="+e+"]").hasClass("open-drawer")||(console.log("A"),o(".original[name="+e+"]").toggleClass("invisible"),o(".parallelogram.cloned[name="+e+"]").toggleClass("invisible"),o("div:not([name="+e+"]).drawer").removeClass("open-drawer"),o("div:not([name="+e+"]).drawer").on("transitionend webkitTransitionEnd oTransitionEnd",function(){o("div:not([name="+e+"]).drawer").hasClass("open-drawer")||o("div:not([name="+e+"]).drawer").addClass("hidden"),o("div:not([name="+e+"]).drawer").off("transitionend webkitTransitionEnd oTransitionEnd")}),o("div.drawer[name="+e+"]").removeClass("hidden"),o("div.drawer[name="+e+"]").toggleClass("open-drawer"),o(".parallelogram.cloned[name="+e+"]").css({transform:"translate("+(o(".drawer").width()-5)+"px, 0px) rotate(20deg) skew(20deg)"}))}n(1),n(2);var o=n(3);n(4),o(window).resize(function(){var e=o(".parallelogram.cloned:not('.invisible')");e.css({transform:"translate(0px, 0) rotate(20deg) skew(20deg)"}),e.css({transform:"translate("+(o(".drawer").width()-5)+"px, 0px) rotate(20deg) skew(20deg)"})}),function(){o(document).ready(function(){o("#follow-button").css("background-color","red!important")})}(),o(window).on("load",function(){o(".original").each(function(e,t){var n=o("div[name="+o(t).attr("name")+"].original").clone();n.on("click",function(e){r(o(t).attr("name"),e)}),n.removeClass("original"),n.css({position:"absolute","background-color":o("div[name="+o(t).attr("name")+"].parallelogram"),transform:"rotate(20deg) skew(20deg)","webkit-transform":"rotate(20deg) skew(20deg)","transform-origin":"top left",top:o("div[name="+o(t).attr("name")+"].original").offset().top,left:o("div[name="+o(t).attr("name")+"].original").offset().left,transition:"transform 1s"}),o("nav").append(n),n.addClass("parallelogram"),n.addClass("cloned"),n.toggleClass("invisible")}),o(".original").each(function(e,t){o(t).on("click",function(){i(o(t).attr("name"))})})})},function(e,t){},function(e,t){},function(e,t,n){var r,i;/*!
